...
var passwordCheckOld = function () 
{
    ...
    {
    stringOutput=("Please enter a password that is longer than 8 characters");
    }
    else
    {
        for (var a=0; a < arrayBadPasswords.length; a++)
        {
            ...
            {
                stringOutput=("This password is not valid, please change a new one");
            }
        }  
    }
  /* insert code
 ...
 if (stringOutput==="")
 {
    stringOutput= "Congratulations! This is a great password";
 }
